...
copyright = f'2026–{year}, NLnet Labs'
...
try:
    response_versions = requests.get(
        f"https://readthedocs.org/api/v2/version/?project__slug=ods2cascade&active=true",
        timeout=2,
    ).json()
    versions = [
...
htmlhelp_basename = 'Ods2CascadeUserManualdoc'
...
man_pages = [
    ('man/ods2cascade', 'ods2cascade', 'Ods2Cascade CLI', author, 1),
]
...
texinfo_documents = [
    (master_doc, 'Ods2CascadeUserManual', 'Ods2Cascade User Manual',
     author, 'Ods2CascadeUserManual', 'One line description of project.',
     'Miscellaneous'),
]
